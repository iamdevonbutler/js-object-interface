 ...
 */
function applyInterface(src, methods = null, clone = true) {
  var obj;
  ...
  obj.clone = (wrap = false) => {
    var result = wrap ? applyInterface(objectAssign(obj.src)) : objectAssign(obj.src);
    return result;
  };
   ...
   */
  obj._wrap = (obj1) => {
    var result = isObject(obj1) ? applyInterface(obj1, null, clone) : undefined;
    return result;
  };
